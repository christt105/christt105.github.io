...
description: "Tercera y última entrega de la serie sobre mi Media Tracker. Explico cómo usar Hugo para visualizar notas de Obsidian y cómo automatizar todo el proceso."
date: 2026-05-03
image: cover.png
keywords: ["Hugo", "Obsidian", "Media Tracker", "Python", "Automatización", "GitHub Actions", "Self-hosting"]
readingTime: true
comments: true
draft: false
categories:
...
Dejaré este proyecto por un tiempo pero tengo muchas ideas para ir mejorando. Me gustaría añadir gráficos para mostrar estadísticas de lo que veo y juego. También me gustaría añadir un sistema de filtros en la pantalla principal para poder filtrar por tipo y etiquetas, y así eliminar las secciones. Me gustaría añadir un motor de búsqueda para poder ir directamente a la nota por nombre. También me gustaría añadir un calendario con todos los elementos en cada día. Finalmente, debería dedicarle algo de tiempo a optimizar la web, añadir elementos relacionados en cada nota y mejorar la lógica de series y temporadas.

Otra cosa importante a hacer es separar el theme de la página; de esta forma cualquiera puede tener su página y modificarla.

## Conclusiones
No es la herramienta más cómoda de configurar y usar, pero tiene todo lo que quiero. Esto no es ningún tutorial, por lo que hay muchos archivos que no los he puesto para no hacer el post muy largo. Si estás interesado en que publique un tutorial sobre cómo crear este Media Tracker, házmelo saber en los comentarios de abajo.

Mi idea principal era dividir el theme de la página web y explicar cómo configurarlo todo para que cualquiera pueda tener su página web de Media Tracker, pero últimamente he estado muy liado y no estoy seguro de si mucha gente fuera a usarlo. Así que de momento lo voy a dejar así; si alguien quiere usarlo que haga un fork del repositorio y lo modifique a su gusto.
